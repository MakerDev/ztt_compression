...
# Import our PythiaComp implementation
from models.pythia.PythiaComp import PythiaCompForCausalLM
...
def parse_args():
    ...
    init_parser.add_argument(
        "--preset", "-p",
        type=str, default="pythia_1b_cycle5",
    ...
    parser = argparse.ArgumentParser(
        parents=[init_parser],
        description="Fine-tune PythiaComp on multiple datasets",
...
class PythiaCompTrainer(SFTTrainer):
    """Custom trainer for PythiaComp with distillation support"""
...
def main():
    ...
    print(f"Loading PythiaComp model from {args.model_name}...")
    model = PythiaCompForCausalLM.from_pretrained(
        args.model_name,
